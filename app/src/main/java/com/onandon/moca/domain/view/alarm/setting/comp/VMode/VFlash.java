...
public class VFlash implements OCustomViewCompLifeCycle, CompoundButton.OnCheckedChangeListener {
    ...
    public void update(MAlarmData mAlarmData){
        ...
        this.aSwitch.setCheckedWithoutAnimation(mAlarmData.isFlashChecked());
    }
