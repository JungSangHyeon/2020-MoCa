...
public class AlarmSettingItem extends LinearLayout implements View.OnClickListener {
    ...
    private OToggleButton onOffButton;
    ...
    public OToggleButton getOnOffButton() { return onOffButton; }
}
